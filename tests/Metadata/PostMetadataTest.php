...
use Jitesoft\wOOPress\Metadata\PostMetadata;
use Jitesoft\wOOPress\Tests\AbstractTestCase;

class PostMetadataTest extends AbstractTestCase {
    ...
    protected function setUp() {
        ...
        $this->meta = new PostMetadata(10, "abc123", "testvalue");
    }

    public function testType() {
        $this->assertEquals(MetadataInterface::META_TYPE_POST, $this->meta->getMetaType());
    }
