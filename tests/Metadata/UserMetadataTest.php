...
use Jitesoft\wOOPress\Metadata\UserMetadata;
use Jitesoft\wOOPress\Tests\AbstractTestCase;

class UserMetadataTest extends AbstractTestCase {
    ...
    protected function setUp() {
        ...
        $this->meta = new UserMetadata(10, "abc123", "testvalue");
    }

    public function testType() {
        $this->assertEquals(MetadataInterface::META_TYPE_USER, $this->meta->getMetaType());
    }
